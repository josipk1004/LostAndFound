...
abstract class NotificationDb : RoomDatabase() {
    ...
    companion object {
        ...
        @Synchronized
        fun get(context: Context): NotificationDb {
            if (instance == null) {
                instance = Room.databaseBuilder(
                    context.applicationContext,
                    NotificationDb::class.java,
                    "_root_ide_package_.com.example.lostandfound.NotificationDatabase"
                )
        ...
        private fun fillInDb(context: Context) {
            ...
            ioThread {
                get(context).notificationDao().insert(
                    CHEESE_DATA.map {
                        Notification(
                            title = it,
                            adress = "",
...
//                            date = Date(), TODO
                            description = "",
                            user = "this is user, the other is title"
